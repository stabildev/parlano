  ...
  return (
    <>
      <MaxWidthWrapper className="mb-12 mt-28 flex flex-col items-center justify-center text-center sm:mt-40">
        <div className="group relative mx-auto mb-4 cursor-default rounded-full border border-border bg-gradient-to-b from-border/25 to-border px-5 py-1.5 shadow transition-all hover:bg-border dark:border-border/10 dark:hover:border-border/50">
          ...
          <div>
            <div className="mx-auto max-w-6xl px-6 lg:px-8">
              <div className="mt-16 flow-root sm:mt-24">
                <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 dark:bg-white/10 dark:ring-white/20 lg:-m-4 lg:rounded-2xl lg:p-4">
                  <Image
